...
public class QRental extends EntityPathBase<Rental> {
    ...
    public final DatePath<java.sql.Date> rentalEndDate = createDate("rentalEndDate", java.sql.Date.class);

    public final NumberPath<Integer> rentalPeriod = createNumber("rentalPeriod", Integer.class);

    public final DatePath<java.sql.Date> rentalStartDate = createDate("rentalStartDate", java.sql.Date.class);
