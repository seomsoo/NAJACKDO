...
const ProfilePage = () => {
  ...
  const user = {
    ...
    myLeaf: 12000,
    isMine: false,
    bookCase: ["https://placehold.co/71x104", "https://placehold.co/71x104", "https://placehold.co/71x104", "https://placehold.co/71x104", "https://placehold.co/71x104", "https://placehold.co/71x104"]
  }
    ...
    <div className='mx-[25px] mt-6'>
      ...
      {user.isMine && (
        <>
          ...
          <div>
            <button className='w-full h-[40px]  my-6 bg-[#776B5D] rounded-lg  font-medium text-white'>로그아웃</button>
          </div>
        </>
      )}
      {!user.isMine && (
