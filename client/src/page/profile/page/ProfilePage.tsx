...
const ProfilePage = () => {
  ...
  return (
    <div className="mx-[25px] mt-6">
      ...
      <div
        onClick={goToGrade}
        className="my-6 bg-white/30 shadow rounded-lg p-4"
      >
      ...
      {user.isMine && (
        <>
          ...
          <div
            onClick={goToLeaf}
            className="my-6 bg-[#FAF9F7] shadow rounded-lg p-4"
          >
            <div className="flex flex-row items-center mb-2">
            ...
            <div className="flex flex-row items-center">
              ...
              <p className="text-[20px] text-[#776B5D]">
                {user.myLeaf.toLocaleString()}
              </p>
            </div>
            <LeafBarGraph
              ratio={1500 / 1800}
